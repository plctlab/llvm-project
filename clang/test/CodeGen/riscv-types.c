...
vint64m2_t test_vint64m2_t() {
  // CHECK: define dso_local <vscale x 2 x i64> @test_vint64m2_t() #0 {
...
vint32m1_t test_vint32m1_t() {
  // CHECK: define dso_local <vscale x 1 x i32> @test_vint32m1_t() #0 {
...
vint16m1_t test_vint16m1_t() {
  // CHECK: define dso_local <vscale x 1 x i16> @test_vint16m1_t() #0 {
...
vint8m1_t test_vint8m1_t() {
  // CHECK: define dso_local <vscale x 1 x i8> @test_vint8m1_t() #0 {
...
vuint8m1_t test_vuint8m1_t() {
  // CHECK: define dso_local <vscale x 1 x i8> @test_vuint8m1_t() #0 {
  // CHECK: %x = alloca <vscale x 1 x i8>, align 1
...
vfloat32m1_t test_vfloat32m1_t() {
  // CHECK: define dso_local <vscale x 1 x float> @test_vfloat32m1_t() #0 {
...
vfloat16m1_t test_vfloat16m1_t() {
  // CHECK: define dso_local <vscale x 1 x half> @test_vfloat16m1_t() #0 {
...
vbool64_t test_vbool64_t() {
  // CHECK: define dso_local <64 x i1> @test_vbool64_t() #2 {
  // CHECK: %x = alloca <64 x i1>, align 64
  // CHECK: %call = call <64 x i1> bitcast (<64 x i1> (...)* @generate_vbool64_t to <64 x i1> ()*)()
  // CHECK: store <64 x i1> %call, <64 x i1>* %x, align 64
  // CHECK: %0 = load <64 x i1>, <64 x i1>* %x, align 64
  // CHECK: call void @consume_vbool64_t(<64 x i1> %0)
  // CHECK: %1 = load <64 x i1>, <64 x i1>* %x, align 64
  // CHECK: ret <64 x i1> %1
  vbool64_t x = generate_vbool64_t();
  consume_vbool64_t(x);
  return x;
}
// CHECK: declare dso_local <64 x i1> @generate_vbool64_t(...) #1
// CHECK: declare dso_local void @consume_vbool64_t(<64 x i1>) #1
...
vbool2_t test_vbool2_t() {
  // CHECK: define dso_local <2 x i1> @test_vbool2_t() #3 {
  // CHECK: %x = alloca <2 x i1>, align 2
  // CHECK: %call = call <2 x i1> bitcast (<2 x i1> (...)* @generate_vbool2_t to <2 x i1> ()*)()
  // CHECK: store <2 x i1> %call, <2 x i1>* %x, align 2
  // CHECK: %0 = load <2 x i1>, <2 x i1>* %x, align 2
  // CHECK: call void @consume_vbool2_t(<2 x i1> %0)
  // CHECK: %1 = load <2 x i1>, <2 x i1>* %x, align 2
  // CHECK: ret <2 x i1> %1
  vbool2_t x = generate_vbool2_t();
  consume_vbool2_t(x);
  return x;
}
// CHECK: declare dso_local <2 x i1> @generate_vbool2_t(...) #1
// CHECK: declare dso_local void @consume_vbool2_t(<2 x i1>) #1
...
vbool1_t test_vbool1_t() {
  // CHECK: define dso_local <1 x i1> @test_vbool1_t() #4 {
  // CHECK: %x = alloca <1 x i1>, align 1
  // CHECK: %call = call <1 x i1> bitcast (<1 x i1> (...)* @generate_vbool1_t to <1 x i1> ()*)()
  // CHECK: store <1 x i1> %call, <1 x i1>* %x, align 1
  // CHECK: %0 = load <1 x i1>, <1 x i1>* %x, align 1
  // CHECK: call void @consume_vbool1_t(<1 x i1> %0)
  // CHECK: %1 = load <1 x i1>, <1 x i1>* %x, align 1
  // CHECK: ret <1 x i1> %1
  vbool1_t x = generate_vbool1_t();
  consume_vbool1_t(x);
  return x;
}
// CHECK: declare dso_local <1 x i1> @generate_vbool1_t(...) #1
// CHECK: declare dso_local void @consume_vbool1_t(<1 x i1>) #1
...
vint64m1x8_t test_vint64m1x8_t() {
  // CHECK: define dso_local void @test_vint64m1x8_t(%struct.vint64m1x8_t* noalias sret %agg.result) #0 {
  ...
  // CHECK: call void bitcast (void (%struct.vint64m1x8_t*, ...)* @generate_vint64m1x8_t to void (%struct.vint64m1x8_t*)*)(%struct.vint64m1x8_t* sret %agg.result)
...
// CHECK: declare dso_local void @generate_vint64m1x8_t(%struct.vint64m1x8_t* sret, ...) #1
...
vint64m2x4_t test_vint64m2x4_t() {
  // CHECK: define dso_local void @test_vint64m2x4_t(%struct.vint64m2x4_t* noalias sret %agg.result) #0 {
  // CHECK: %result.ptr = alloca i8*, align 4
  // CHECK: %byval-temp = alloca %struct.vint64m2x4_t, align 16
  // CHECK: %0 = bitcast %struct.vint64m2x4_t* %agg.result to i8*
  // CHECK: store i8* %0, i8** %result.ptr, align 4
  // CHECK: call void bitcast (void (%struct.vint64m2x4_t*, ...)* @generate_vint64m2x4_t to void (%struct.vint64m2x4_t*)*)(%struct.vint64m2x4_t* sret %agg.result)
...
// CHECK: declare dso_local void @generate_vint64m2x4_t(%struct.vint64m2x4_t* sret, ...) #1
...
vint64m8x1_t test_vint64m8x1_t() {
  // CHECK: define dso_local void @test_vint64m8x1_t(%struct.vint64m8x1_t* noalias sret %agg.result) #0 {
  // CHECK: %result.ptr = alloca i8*, align 4
  // CHECK: %byval-temp = alloca %struct.vint64m8x1_t, align 64
  // CHECK: %0 = bitcast %struct.vint64m8x1_t* %agg.result to i8*
  // CHECK: store i8* %0, i8** %result.ptr, align 4
  // CHECK: call void bitcast (void (%struct.vint64m8x1_t*, ...)* @generate_vint64m8x1_t to void (%struct.vint64m8x1_t*)*)(%struct.vint64m8x1_t* sret %agg.result)
...
// CHECK: declare dso_local void @generate_vint64m8x1_t(%struct.vint64m8x1_t* sret, ...) #1
