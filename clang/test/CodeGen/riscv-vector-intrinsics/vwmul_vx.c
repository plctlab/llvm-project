...
vint16mf4_t test_vwmul_vx_i16mf4_m (vbool64_t mask, vint16mf4_t maskedoff, vint8mf8_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i16> @llvm.riscv.vwmul.vx.{{.*}}nxv1i16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x i8> %{{.*}}, i8 %{{.*}})
...
vint16mf2_t test_vwmul_vx_i16mf2_m (vbool32_t mask, vint16mf2_t maskedoff, vint8mf4_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i16> @llvm.riscv.vwmul.vx.{{.*}}nxv2i16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x i8> %{{.*}}, i8 %{{.*}})
...
vint16m1_t test_vwmul_vx_i16m1_m (vbool16_t mask, vint16m1_t maskedoff, vint8mf2_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i16> @llvm.riscv.vwmul.vx.{{.*}}nxv4i16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x i8> %{{.*}}, i8 %{{.*}})
...
vint16m2_t test_vwmul_vx_i16m2_m (vbool8_t mask, vint16m2_t maskedoff, vint8m1_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i16> @llvm.riscv.vwmul.vx.{{.*}}nxv8i16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x i8> %{{.*}}, i8 %{{.*}})
...
vint16m4_t test_vwmul_vx_i16m4_m (vbool4_t mask, vint16m4_t maskedoff, vint8m2_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i16> @llvm.riscv.vwmul.vx.{{.*}}nxv16i16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i16> %{{.*}}, <vscale x 16 x i8> %{{.*}}, i8 %{{.*}})
...
vint16m8_t test_vwmul_vx_i16m8_m (vbool2_t mask, vint16m8_t maskedoff, vint8m4_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i16> @llvm.riscv.vwmul.vx.{{.*}}nxv32i16{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i16> %{{.*}}, <vscale x 32 x i8> %{{.*}}, i8 %{{.*}})
...
vint32mf2_t test_vwmul_vx_i32mf2_m (vbool64_t mask, vint32mf2_t maskedoff, vint16mf4_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vwmul.vx.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i32> %{{.*}}, <vscale x 1 x i16> %{{.*}}, i16 %{{.*}})
...
vint32m1_t test_vwmul_vx_i32m1_m (vbool32_t mask, vint32m1_t maskedoff, vint16mf2_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vwmul.vx.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i32> %{{.*}}, <vscale x 2 x i16> %{{.*}}, i16 %{{.*}})
...
vint32m2_t test_vwmul_vx_i32m2_m (vbool16_t mask, vint32m2_t maskedoff, vint16m1_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vwmul.vx.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i32> %{{.*}}, <vscale x 4 x i16> %{{.*}}, i16 %{{.*}})
...
vint32m4_t test_vwmul_vx_i32m4_m (vbool8_t mask, vint32m4_t maskedoff, vint16m2_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vwmul.vx.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i32> %{{.*}}, <vscale x 8 x i16> %{{.*}}, i16 %{{.*}})
...
vint32m8_t test_vwmul_vx_i32m8_m (vbool4_t mask, vint32m8_t maskedoff, vint16m4_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i32> @llvm.riscv.vwmul.vx.{{.*}}nxv16i32{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i32> %{{.*}}, <vscale x 16 x i16> %{{.*}}, i16 %{{.*}})
...
vint64m1_t test_vwmul_vx_i64m1_m (vbool64_t mask, vint64m1_t maskedoff, vint32mf2_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i64> @llvm.riscv.vwmul.vx.{{.*}}nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i64> %{{.*}}, <vscale x 1 x i32> %{{.*}}, i32 %{{.*}})
...
vint64m2_t test_vwmul_vx_i64m2_m (vbool32_t mask, vint64m2_t maskedoff, vint32m1_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i64> @llvm.riscv.vwmul.vx.{{.*}}nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i64> %{{.*}}, <vscale x 2 x i32> %{{.*}}, i32 %{{.*}})
...
vint64m4_t test_vwmul_vx_i64m4_m (vbool16_t mask, vint64m4_t maskedoff, vint32m2_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i64> @llvm.riscv.vwmul.vx.{{.*}}nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i64> %{{.*}}, <vscale x 4 x i32> %{{.*}}, i32 %{{.*}})
...
vint64m8_t test_vwmul_vx_i64m8_m (vbool8_t mask, vint64m8_t maskedoff, vint32m4_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i64> @llvm.riscv.vwmul.vx.{{.*}}nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i64> %{{.*}}, <vscale x 8 x i32> %{{.*}}, i32 %{{.*}})
