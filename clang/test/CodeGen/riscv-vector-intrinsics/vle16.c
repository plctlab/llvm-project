...
vint16mf4_t test_vle16_v_i16mf4_m (vbool64_t mask, vint16mf4_t maskedoff, int16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i16> @llvm.riscv.vle16.v.mask.nxv1i16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i16> %{{.*}}, i16 %{{.*}})
...
vint16mf2_t test_vle16_v_i16mf2_m (vbool32_t mask, vint16mf2_t maskedoff, int16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i16> @llvm.riscv.vle16.v.mask.nxv2i16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i16> %{{.*}}, i16 %{{.*}})
...
vint16m1_t test_vle16_v_i16m1_m (vbool16_t mask, vint16m1_t maskedoff, int16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i16> @llvm.riscv.vle16.v.mask.nxv4i16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i16> %{{.*}}, i16 %{{.*}})
...
vint16m2_t test_vle16_v_i16m2_m (vbool8_t mask, vint16m2_t maskedoff, int16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i16> @llvm.riscv.vle16.v.mask.nxv8i16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i16> %{{.*}}, i16 %{{.*}})
...
vint16m4_t test_vle16_v_i16m4_m (vbool4_t mask, vint16m4_t maskedoff, int16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i16> @llvm.riscv.vle16.v.mask.nxv16i16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i16> %{{.*}}, i16 %{{.*}})
...
vint16m8_t test_vle16_v_i16m8_m (vbool2_t mask, vint16m8_t maskedoff, int16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i16> @llvm.riscv.vle16.v.mask.nxv32i16{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i16> %{{.*}}, i16 %{{.*}})
...
vfloat16mf4_t test_vle16_v_f16mf4_m (vbool64_t mask, vfloat16mf4_t maskedoff, float16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x half> @llvm.riscv.vle16.v.mask.nxv1f16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x half> %{{.*}}, half %{{.*}})
...
vfloat16mf2_t test_vle16_v_f16mf2_m (vbool32_t mask, vfloat16mf2_t maskedoff, float16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x half> @llvm.riscv.vle16.v.mask.nxv2f16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x half> %{{.*}}, half %{{.*}})
...
vfloat16m1_t test_vle16_v_f16m1_m (vbool16_t mask, vfloat16m1_t maskedoff, float16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x half> @llvm.riscv.vle16.v.mask.nxv4f16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x half> %{{.*}}, half %{{.*}})
...
vfloat16m2_t test_vle16_v_f16m2_m (vbool8_t mask, vfloat16m2_t maskedoff, float16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x half> @llvm.riscv.vle16.v.mask.nxv8f16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x half> %{{.*}}, half %{{.*}})
...
vfloat16m4_t test_vle16_v_f16m4_m (vbool4_t mask, vfloat16m4_t maskedoff, float16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x half> @llvm.riscv.vle16.v.mask.nxv16f16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x half> %{{.*}}, half %{{.*}})
...
vfloat16m8_t test_vle16_v_f16m8_m (vbool2_t mask, vfloat16m8_t maskedoff, float16_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x half> @llvm.riscv.vle16.v.mask.nxv32f16{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x half> %{{.*}}, half %{{.*}})
