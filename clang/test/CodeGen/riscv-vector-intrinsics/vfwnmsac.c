...
vfloat64m1_t test_vfwnmsac_vv_f64m1 (vfloat64m1_t acc, vfloat32mf2_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwnmsac.vv.nxv1f32{{.*}}(<vscale x 1 x double> %{{.*}}, <vscale x 1 x float> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m1_t test_vfwnmsac_vf_f64m1 (vfloat64m1_t acc, float32_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwnmsac.vf.nxv1f32{{.*}}(<vscale x 1 x double> %{{.*}}, float %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m2_t test_vfwnmsac_vv_f64m2 (vfloat64m2_t acc, vfloat32m1_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwnmsac.vv.nxv2f32{{.*}}(<vscale x 2 x double> %{{.*}}, <vscale x 2 x float> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m2_t test_vfwnmsac_vf_f64m2 (vfloat64m2_t acc, float32_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwnmsac.vf.nxv2f32{{.*}}(<vscale x 2 x double> %{{.*}}, float %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m4_t test_vfwnmsac_vv_f64m4 (vfloat64m4_t acc, vfloat32m2_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwnmsac.vv.nxv4f32{{.*}}(<vscale x 4 x double> %{{.*}}, <vscale x 4 x float> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m4_t test_vfwnmsac_vf_f64m4 (vfloat64m4_t acc, float32_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwnmsac.vf.nxv4f32{{.*}}(<vscale x 4 x double> %{{.*}}, float %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m8_t test_vfwnmsac_vv_f64m8 (vfloat64m8_t acc, vfloat32m4_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwnmsac.vv.nxv8f32{{.*}}(<vscale x 8 x double> %{{.*}}, <vscale x 8 x float> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m8_t test_vfwnmsac_vf_f64m8 (vfloat64m8_t acc, float32_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwnmsac.vf.nxv8f32{{.*}}(<vscale x 8 x double> %{{.*}}, float %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m1_t test_vfwnmsac_vv_f64m1_m (vbool64_t mask, vfloat64m1_t acc, vfloat32mf2_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwnmsac.vv.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x float> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m1_t test_vfwnmsac_vf_f64m1_m (vbool64_t mask, vfloat64m1_t acc, float32_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwnmsac.vf.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, float %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m2_t test_vfwnmsac_vv_f64m2_m (vbool32_t mask, vfloat64m2_t acc, vfloat32m1_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwnmsac.vv.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x float> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m2_t test_vfwnmsac_vf_f64m2_m (vbool32_t mask, vfloat64m2_t acc, float32_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwnmsac.vf.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, float %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m4_t test_vfwnmsac_vv_f64m4_m (vbool16_t mask, vfloat64m4_t acc, vfloat32m2_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwnmsac.vv.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x float> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m4_t test_vfwnmsac_vf_f64m4_m (vbool16_t mask, vfloat64m4_t acc, float32_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwnmsac.vf.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, float %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m8_t test_vfwnmsac_vv_f64m8_m (vbool8_t mask, vfloat64m8_t acc, vfloat32m4_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwnmsac.vv.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x float> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m8_t test_vfwnmsac_vf_f64m8_m (vbool8_t mask, vfloat64m8_t acc, float32_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwnmsac.vf.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, float %{{.*}}, <vscale x 8 x float> %{{.*}})
