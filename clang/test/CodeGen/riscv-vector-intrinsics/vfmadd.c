...
vfloat64m1_t test_vfmadd_vv_f64m1 (vfloat64m1_t acc, vfloat64m1_t op1, vfloat64m1_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m1
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfmadd.vv.{{.*}}nxv1f64{{.*}}(<vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
  return vfmadd_vv_f64m1(acc, op1, op2);
}

vfloat64m1_t test_vfmadd_vf_f64m1 (vfloat64m1_t acc, float64_t op1, vfloat64m1_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m1
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfmadd.vf.{{.*}}nxv1f64{{.*}}(<vscale x 1 x double> %{{.*}}, double %{{.*}}, <vscale x 1 x double> %{{.*}})
  return vfmadd_vf_f64m1(acc, op1, op2);
}

vfloat64m2_t test_vfmadd_vv_f64m2 (vfloat64m2_t acc, vfloat64m2_t op1, vfloat64m2_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m2
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfmadd.vv.{{.*}}nxv2f64{{.*}}(<vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
  return vfmadd_vv_f64m2(acc, op1, op2);
}

vfloat64m2_t test_vfmadd_vf_f64m2 (vfloat64m2_t acc, float64_t op1, vfloat64m2_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m2
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfmadd.vf.{{.*}}nxv2f64{{.*}}(<vscale x 2 x double> %{{.*}}, double %{{.*}}, <vscale x 2 x double> %{{.*}})
  return vfmadd_vf_f64m2(acc, op1, op2);
}

vfloat64m4_t test_vfmadd_vv_f64m4 (vfloat64m4_t acc, vfloat64m4_t op1, vfloat64m4_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m4
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfmadd.vv.{{.*}}nxv4f64{{.*}}(<vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
  return vfmadd_vv_f64m4(acc, op1, op2);
}

vfloat64m4_t test_vfmadd_vf_f64m4 (vfloat64m4_t acc, float64_t op1, vfloat64m4_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m4
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfmadd.vf.{{.*}}nxv4f64{{.*}}(<vscale x 4 x double> %{{.*}}, double %{{.*}}, <vscale x 4 x double> %{{.*}})
  return vfmadd_vf_f64m4(acc, op1, op2);
}

vfloat64m8_t test_vfmadd_vv_f64m8 (vfloat64m8_t acc, vfloat64m8_t op1, vfloat64m8_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m8
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfmadd.vv.{{.*}}nxv8f64{{.*}}(<vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
  return vfmadd_vv_f64m8(acc, op1, op2);
}

vfloat64m8_t test_vfmadd_vf_f64m8 (vfloat64m8_t acc, float64_t op1, vfloat64m8_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m8
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfmadd.vf.{{.*}}nxv8f64{{.*}}(<vscale x 8 x double> %{{.*}}, double %{{.*}}, <vscale x 8 x double> %{{.*}})
  return vfmadd_vf_f64m8(acc, op1, op2);
}
...
vfloat64m1_t test_vfmadd_vv_f64m1_m (vbool64_t mask, vfloat64m1_t acc, vfloat64m1_t op1, vfloat64m1_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m1_m
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfmadd.vv.mask.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
  return vfmadd_vv_f64m1_m(mask, acc, op1, op2);
}

vfloat64m1_t test_vfmadd_vf_f64m1_m (vbool64_t mask, vfloat64m1_t acc, float64_t op1, vfloat64m1_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m1_m
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfmadd.vf.mask.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, double %{{.*}}, <vscale x 1 x double> %{{.*}})
  return vfmadd_vf_f64m1_m(mask, acc, op1, op2);
}

vfloat64m2_t test_vfmadd_vv_f64m2_m (vbool32_t mask, vfloat64m2_t acc, vfloat64m2_t op1, vfloat64m2_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m2_m
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfmadd.vv.mask.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
  return vfmadd_vv_f64m2_m(mask, acc, op1, op2);
}

vfloat64m2_t test_vfmadd_vf_f64m2_m (vbool32_t mask, vfloat64m2_t acc, float64_t op1, vfloat64m2_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m2_m
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfmadd.vf.mask.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, double %{{.*}}, <vscale x 2 x double> %{{.*}})
  return vfmadd_vf_f64m2_m(mask, acc, op1, op2);
}

vfloat64m4_t test_vfmadd_vv_f64m4_m (vbool16_t mask, vfloat64m4_t acc, vfloat64m4_t op1, vfloat64m4_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m4_m
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfmadd.vv.mask.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
  return vfmadd_vv_f64m4_m(mask, acc, op1, op2);
}

vfloat64m4_t test_vfmadd_vf_f64m4_m (vbool16_t mask, vfloat64m4_t acc, float64_t op1, vfloat64m4_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m4_m
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfmadd.vf.mask.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, double %{{.*}}, <vscale x 4 x double> %{{.*}})
  return vfmadd_vf_f64m4_m(mask, acc, op1, op2);
}

vfloat64m8_t test_vfmadd_vv_f64m8_m (vbool8_t mask, vfloat64m8_t acc, vfloat64m8_t op1, vfloat64m8_t op2) {
  // CHECK-LABEL: test_vfmadd_vv_f64m8_m
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfmadd.vv.mask.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
  return vfmadd_vv_f64m8_m(mask, acc, op1, op2);
}

vfloat64m8_t test_vfmadd_vf_f64m8_m (vbool8_t mask, vfloat64m8_t acc, float64_t op1, vfloat64m8_t op2) {
  // CHECK-LABEL: test_vfmadd_vf_f64m8_m
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfmadd.vf.mask.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, double %{{.*}}, <vscale x 8 x double> %{{.*}})
  return vfmadd_vf_f64m8_m(mask, acc, op1, op2);
}
