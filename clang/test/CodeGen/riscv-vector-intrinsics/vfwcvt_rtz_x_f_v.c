...
vint32mf2_t test_vfwcvt_rtz_x_f_v_i32mf2_m (vbool64_t mask, vint32mf2_t maskedoff, vfloat16mf4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i32> %{{.*}}, <vscale x 1 x half> %{{.*}})
...
vint32m1_t test_vfwcvt_rtz_x_f_v_i32m1_m (vbool32_t mask, vint32m1_t maskedoff, vfloat16mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i32> %{{.*}}, <vscale x 2 x half> %{{.*}})
...
vint32m2_t test_vfwcvt_rtz_x_f_v_i32m2_m (vbool16_t mask, vint32m2_t maskedoff, vfloat16m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i32> %{{.*}}, <vscale x 4 x half> %{{.*}})
...
vint32m4_t test_vfwcvt_rtz_x_f_v_i32m4_m (vbool8_t mask, vint32m4_t maskedoff, vfloat16m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i32> %{{.*}}, <vscale x 8 x half> %{{.*}})
...
vint32m8_t test_vfwcvt_rtz_x_f_v_i32m8_m (vbool4_t mask, vint32m8_t maskedoff, vfloat16m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i32> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv16i32{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i32> %{{.*}}, <vscale x 16 x half> %{{.*}})
...
vint64m1_t test_vfwcvt_rtz_x_f_v_i64m1_m (vbool64_t mask, vint64m1_t maskedoff, vfloat32mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i64> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i64> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vint64m2_t test_vfwcvt_rtz_x_f_v_i64m2_m (vbool32_t mask, vint64m2_t maskedoff, vfloat32m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i64> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i64> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vint64m4_t test_vfwcvt_rtz_x_f_v_i64m4_m (vbool16_t mask, vint64m4_t maskedoff, vfloat32m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i64> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i64> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vint64m8_t test_vfwcvt_rtz_x_f_v_i64m8_m (vbool8_t mask, vint64m8_t maskedoff, vfloat32m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i64> @llvm.riscv.vfwcvt.rtz.x.f.v.{{.*}}nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i64> %{{.*}}, <vscale x 8 x float> %{{.*}})
