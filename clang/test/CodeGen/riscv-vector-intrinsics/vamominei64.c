...
vint32mf2_t test_vamominei64_v_i32mf2_m (vbool64_t mask, int32_t *base, vuint64m1_t bindex, vint32mf2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vamominei64.v.mask.nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, i32 %{{.*}}, <vscale x 1 x i64> %{{.*}}, <vscale x 1 x i32> %{{.*}})
...
vint32m1_t test_vamominei64_v_i32m1_m (vbool32_t mask, int32_t *base, vuint64m2_t bindex, vint32m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vamominei64.v.mask.nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, i32 %{{.*}}, <vscale x 2 x i64> %{{.*}}, <vscale x 2 x i32> %{{.*}})
...
vint32m2_t test_vamominei64_v_i32m2_m (vbool16_t mask, int32_t *base, vuint64m4_t bindex, vint32m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vamominei64.v.mask.nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, i32 %{{.*}}, <vscale x 4 x i64> %{{.*}}, <vscale x 4 x i32> %{{.*}})
...
vint32m4_t test_vamominei64_v_i32m4_m (vbool8_t mask, int32_t *base, vuint64m8_t bindex, vint32m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vamominei64.v.mask.nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, i32 %{{.*}}, <vscale x 8 x i64> %{{.*}}, <vscale x 8 x i32> %{{.*}})
...
vint64m1_t test_vamominei64_v_i64m1_m (vbool64_t mask, int64_t *base, vuint64m1_t bindex, vint64m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i64> @llvm.riscv.vamominei64.v.mask.nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, i64 %{{.*}}, <vscale x 1 x i64> %{{.*}}, <vscale x 1 x i64> %{{.*}})
...
vint64m2_t test_vamominei64_v_i64m2_m (vbool32_t mask, int64_t *base, vuint64m2_t bindex, vint64m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i64> @llvm.riscv.vamominei64.v.mask.nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, i64 %{{.*}}, <vscale x 2 x i64> %{{.*}}, <vscale x 2 x i64> %{{.*}})
...
vint64m4_t test_vamominei64_v_i64m4_m (vbool16_t mask, int64_t *base, vuint64m4_t bindex, vint64m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i64> @llvm.riscv.vamominei64.v.mask.nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, i64 %{{.*}}, <vscale x 4 x i64> %{{.*}}, <vscale x 4 x i64> %{{.*}})
...
vint64m8_t test_vamominei64_v_i64m8_m (vbool8_t mask, int64_t *base, vuint64m8_t bindex, vint64m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i64> @llvm.riscv.vamominei64.v.mask.nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, i64 %{{.*}}, <vscale x 8 x i64> %{{.*}}, <vscale x 8 x i64> %{{.*}})
