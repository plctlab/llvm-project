...
vfloat64m1_t test_vfwadd_vv_f64m1 (vfloat32mf2_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.vv.nxv1f32{{.*}}(<vscale x 1 x float> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m1_t test_vfwadd_vf_f64m1 (vfloat32mf2_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.vf.nxv1f32{{.*}}(<vscale x 1 x float> %{{.*}}, float %{{.*}})
...
vfloat64m1_t test_vfwadd_wv_f64m1 (vfloat64m1_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.wv.nxv1f32{{.*}}(<vscale x 1 x double> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m1_t test_vfwadd_wf_f64m1 (vfloat64m1_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.wf.nxv1f32{{.*}}(<vscale x 1 x double> %{{.*}}, float %{{.*}})
...
vfloat64m2_t test_vfwadd_vv_f64m2 (vfloat32m1_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.vv.nxv2f32{{.*}}(<vscale x 2 x float> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m2_t test_vfwadd_vf_f64m2 (vfloat32m1_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.vf.nxv2f32{{.*}}(<vscale x 2 x float> %{{.*}}, float %{{.*}})
...
vfloat64m2_t test_vfwadd_wv_f64m2 (vfloat64m2_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.wv.nxv2f32{{.*}}(<vscale x 2 x double> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m2_t test_vfwadd_wf_f64m2 (vfloat64m2_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.wf.nxv2f32{{.*}}(<vscale x 2 x double> %{{.*}}, float %{{.*}})
...
vfloat64m4_t test_vfwadd_vv_f64m4 (vfloat32m2_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.vv.nxv4f32{{.*}}(<vscale x 4 x float> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m4_t test_vfwadd_vf_f64m4 (vfloat32m2_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.vf.nxv4f32{{.*}}(<vscale x 4 x float> %{{.*}}, float %{{.*}})
...
vfloat64m4_t test_vfwadd_wv_f64m4 (vfloat64m4_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.wv.nxv4f32{{.*}}(<vscale x 4 x double> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m4_t test_vfwadd_wf_f64m4 (vfloat64m4_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.wf.nxv4f32{{.*}}(<vscale x 4 x double> %{{.*}}, float %{{.*}})
...
vfloat64m8_t test_vfwadd_vv_f64m8 (vfloat32m4_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.vv.nxv8f32{{.*}}(<vscale x 8 x float> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m8_t test_vfwadd_vf_f64m8 (vfloat32m4_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.vf.nxv8f32{{.*}}(<vscale x 8 x float> %{{.*}}, float %{{.*}})
...
vfloat64m8_t test_vfwadd_wv_f64m8 (vfloat64m8_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.wv.nxv8f32{{.*}}(<vscale x 8 x double> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m8_t test_vfwadd_wf_f64m8 (vfloat64m8_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.wf.nxv8f32{{.*}}(<vscale x 8 x double> %{{.*}}, float %{{.*}})
...
vfloat64m1_t test_vfwadd_vv_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat32mf2_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.vv.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x float> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m1_t test_vfwadd_vf_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat32mf2_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.vf.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x float> %{{.*}}, float %{{.*}})
...
vfloat64m1_t test_vfwadd_wv_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t op1, vfloat32mf2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.wv.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat64m1_t test_vfwadd_wf_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwadd.wf.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, float %{{.*}})
...
vfloat64m2_t test_vfwadd_vv_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat32m1_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.vv.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x float> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m2_t test_vfwadd_vf_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat32m1_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.vf.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x float> %{{.*}}, float %{{.*}})
...
vfloat64m2_t test_vfwadd_wv_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t op1, vfloat32m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.wv.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat64m2_t test_vfwadd_wf_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwadd.wf.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, float %{{.*}})
...
vfloat64m4_t test_vfwadd_vv_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat32m2_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.vv.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x float> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m4_t test_vfwadd_vf_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat32m2_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.vf.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x float> %{{.*}}, float %{{.*}})
...
vfloat64m4_t test_vfwadd_wv_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t op1, vfloat32m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.wv.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat64m4_t test_vfwadd_wf_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwadd.wf.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, float %{{.*}})
...
vfloat64m8_t test_vfwadd_vv_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat32m4_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.vv.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x float> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m8_t test_vfwadd_vf_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat32m4_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.vf.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x float> %{{.*}}, float %{{.*}})
...
vfloat64m8_t test_vfwadd_wv_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t op1, vfloat32m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.wv.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat64m8_t test_vfwadd_wf_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t op1, float32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwadd.wf.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, float %{{.*}})
