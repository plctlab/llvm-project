...
vint16mf4_t test_vfncvt_x_f_w_i16mf4_m (vbool64_t mask, vint16mf4_t maskedoff, vfloat32mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i16> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv1i16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vint16mf2_t test_vfncvt_x_f_w_i16mf2_m (vbool32_t mask, vint16mf2_t maskedoff, vfloat32m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i16> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv2i16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vint16m1_t test_vfncvt_x_f_w_i16m1_m (vbool16_t mask, vint16m1_t maskedoff, vfloat32m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i16> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv4i16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vint16m2_t test_vfncvt_x_f_w_i16m2_m (vbool8_t mask, vint16m2_t maskedoff, vfloat32m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i16> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv8i16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vint16m4_t test_vfncvt_x_f_w_i16m4_m (vbool4_t mask, vint16m4_t maskedoff, vfloat32m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i16> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv16i16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i16> %{{.*}}, <vscale x 16 x float> %{{.*}})
...
vint32mf2_t test_vfncvt_x_f_w_i32mf2_m (vbool64_t mask, vint32mf2_t maskedoff, vfloat64m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i32> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vint32m1_t test_vfncvt_x_f_w_i32m1_m (vbool32_t mask, vint32m1_t maskedoff, vfloat64m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i32> %{{.*}}, <vscale x 2 x double> %{{.*}})
...
vint32m2_t test_vfncvt_x_f_w_i32m2_m (vbool16_t mask, vint32m2_t maskedoff, vfloat64m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i32> %{{.*}}, <vscale x 4 x double> %{{.*}})
...
vint32m4_t test_vfncvt_x_f_w_i32m4_m (vbool8_t mask, vint32m4_t maskedoff, vfloat64m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vfncvt.x.f.w.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i32> %{{.*}}, <vscale x 8 x double> %{{.*}})
