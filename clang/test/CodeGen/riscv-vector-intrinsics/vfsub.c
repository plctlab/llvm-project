...
vfloat64m1_t test_vfsub_vf_f64m1 (vfloat64m1_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vf.{{.*}}nxv1f64{{.*}}(<vscale x 1 x double> %{{.*}}, double %{{.*}})
...
vfloat64m2_t test_vfsub_vv_f64m2 (vfloat64m2_t op1, vfloat64m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vv.{{.*}}nxv2f64{{.*}}(<vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
...
vfloat64m2_t test_vfsub_vf_f64m2 (vfloat64m2_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vf.{{.*}}nxv2f64{{.*}}(<vscale x 2 x double> %{{.*}}, double %{{.*}})
...
vfloat64m4_t test_vfsub_vv_f64m4 (vfloat64m4_t op1, vfloat64m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vv.{{.*}}nxv4f64{{.*}}(<vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
...
vfloat64m4_t test_vfsub_vf_f64m4 (vfloat64m4_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vf.{{.*}}nxv4f64{{.*}}(<vscale x 4 x double> %{{.*}}, double %{{.*}})
...
vfloat64m8_t test_vfsub_vv_f64m8 (vfloat64m8_t op1, vfloat64m8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vv.{{.*}}nxv8f64{{.*}}(<vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
...
vfloat64m8_t test_vfsub_vf_f64m8 (vfloat64m8_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vf.{{.*}}nxv8f64{{.*}}(<vscale x 8 x double> %{{.*}}, double %{{.*}})
...
vfloat64m1_t test_vfsub_vv_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t op1, vfloat64m1_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vv.mask.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m1_t test_vfsub_vf_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vf.mask.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, double %{{.*}})
...
vfloat64m2_t test_vfsub_vv_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t op1, vfloat64m2_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vv.mask.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
...
vfloat64m2_t test_vfsub_vf_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vf.mask.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, double %{{.*}})
...
vfloat64m4_t test_vfsub_vv_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t op1, vfloat64m4_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vv.mask.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
...
vfloat64m4_t test_vfsub_vf_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vf.mask.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, double %{{.*}})
...
vfloat64m8_t test_vfsub_vv_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t op1, vfloat64m8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vv.mask.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
...
vfloat64m8_t test_vfsub_vf_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t op1, float64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vf.mask.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, double %{{.*}})
