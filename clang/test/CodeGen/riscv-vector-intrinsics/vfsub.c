...
vfloat64m1_t test_vfsub_vv_f64m1 (vfloat64m1_t op1, vfloat64m1_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m1
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vv.nxv1f32{{.*}}(<vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
  return vfsub_vv_f64m1(op1, op2);
}

vfloat64m1_t test_vfsub_vf_f64m1 (vfloat64m1_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m1
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vf.nxv1f32{{.*}}(<vscale x 1 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m1(op1, op2);
}

vfloat64m2_t test_vfsub_vv_f64m2 (vfloat64m2_t op1, vfloat64m2_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m2
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vv.nxv2f32{{.*}}(<vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
  return vfsub_vv_f64m2(op1, op2);
}

vfloat64m2_t test_vfsub_vf_f64m2 (vfloat64m2_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m2
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vf.nxv2f32{{.*}}(<vscale x 2 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m2(op1, op2);
}

vfloat64m4_t test_vfsub_vv_f64m4 (vfloat64m4_t op1, vfloat64m4_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m4
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vv.nxv4f32{{.*}}(<vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
  return vfsub_vv_f64m4(op1, op2);
}

vfloat64m4_t test_vfsub_vf_f64m4 (vfloat64m4_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m4
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vf.nxv4f32{{.*}}(<vscale x 4 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m4(op1, op2);
}

vfloat64m8_t test_vfsub_vv_f64m8 (vfloat64m8_t op1, vfloat64m8_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m8
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vv.nxv8f32{{.*}}(<vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
  return vfsub_vv_f64m8(op1, op2);
}

vfloat64m8_t test_vfsub_vf_f64m8 (vfloat64m8_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m8
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vf.nxv8f32{{.*}}(<vscale x 8 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m8(op1, op2);
}
...
vfloat64m1_t test_vfsub_vv_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t op1, vfloat64m1_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m1_m
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vv.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
  return vfsub_vv_f64m1_m(mask, maskedoff, op1, op2);
}

vfloat64m1_t test_vfsub_vf_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m1_m
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfsub.vf.mask.nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m1_m(mask, maskedoff, op1, op2);
}

vfloat64m2_t test_vfsub_vv_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t op1, vfloat64m2_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m2_m
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vv.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
  return vfsub_vv_f64m2_m(mask, maskedoff, op1, op2);
}

vfloat64m2_t test_vfsub_vf_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m2_m
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfsub.vf.mask.nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m2_m(mask, maskedoff, op1, op2);
}

vfloat64m4_t test_vfsub_vv_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t op1, vfloat64m4_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m4_m
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vv.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
  return vfsub_vv_f64m4_m(mask, maskedoff, op1, op2);
}

vfloat64m4_t test_vfsub_vf_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m4_m
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfsub.vf.mask.nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m4_m(mask, maskedoff, op1, op2);
}

vfloat64m8_t test_vfsub_vv_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t op1, vfloat64m8_t op2) {
  // CHECK-LABEL: test_vfsub_vv_f64m8_m
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vv.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
  return vfsub_vv_f64m8_m(mask, maskedoff, op1, op2);
}

vfloat64m8_t test_vfsub_vf_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t op1, float64_t op2) {
  // CHECK-LABEL: test_vfsub_vf_f64m8_m
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfsub.vf.mask.nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, double %{{.*}})
  return vfsub_vf_f64m8_m(mask, maskedoff, op1, op2);
}
