...
vbool64_t test_vmslt_vx_i8mf8_b64_m (vbool64_t mask, vbool64_t maskedoff, vint8mf8_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv1i8{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i1> %{{.*}}, <vscale x 1 x i8> %{{.*}}, i8 %{{.*}})
...
vbool32_t test_vmslt_vx_i8mf4_b32_m (vbool32_t mask, vbool32_t maskedoff, vint8mf4_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv2i8{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i1> %{{.*}}, <vscale x 2 x i8> %{{.*}}, i8 %{{.*}})
...
vbool16_t test_vmslt_vx_i8mf2_b16_m (vbool16_t mask, vbool16_t maskedoff, vint8mf2_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv4i8{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i1> %{{.*}}, <vscale x 4 x i8> %{{.*}}, i8 %{{.*}})
...
vbool8_t test_vmslt_vx_i8m1_b8_m (vbool8_t mask, vbool8_t maskedoff, vint8m1_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv8i8{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i1> %{{.*}}, <vscale x 8 x i8> %{{.*}}, i8 %{{.*}})
...
vbool4_t test_vmslt_vx_i8m2_b4_m (vbool4_t mask, vbool4_t maskedoff, vint8m2_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv16i8{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i1> %{{.*}}, <vscale x 16 x i8> %{{.*}}, i8 %{{.*}})
...
vbool2_t test_vmslt_vx_i8m4_b2_m (vbool2_t mask, vbool2_t maskedoff, vint8m4_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv32i8{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i1> %{{.*}}, <vscale x 32 x i8> %{{.*}}, i8 %{{.*}})
...
vbool1_t test_vmslt_vx_i8m8_b1_m (vbool1_t mask, vbool1_t maskedoff, vint8m8_t op1, int8_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 64 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv64i8{{.*}}(<vscale x 64 x i1> %{{.*}}, <vscale x 64 x i1> %{{.*}}, <vscale x 64 x i8> %{{.*}}, i8 %{{.*}})
...
vbool64_t test_vmslt_vx_i16mf4_b64_m (vbool64_t mask, vbool64_t maskedoff, vint16mf4_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv1i16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i1> %{{.*}}, <vscale x 1 x i16> %{{.*}}, i16 %{{.*}})
...
vbool32_t test_vmslt_vx_i16mf2_b32_m (vbool32_t mask, vbool32_t maskedoff, vint16mf2_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv2i16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i1> %{{.*}}, <vscale x 2 x i16> %{{.*}}, i16 %{{.*}})
...
vbool16_t test_vmslt_vx_i16m1_b16_m (vbool16_t mask, vbool16_t maskedoff, vint16m1_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv4i16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i1> %{{.*}}, <vscale x 4 x i16> %{{.*}}, i16 %{{.*}})
...
vbool8_t test_vmslt_vx_i16m2_b8_m (vbool8_t mask, vbool8_t maskedoff, vint16m2_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv8i16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i1> %{{.*}}, <vscale x 8 x i16> %{{.*}}, i16 %{{.*}})
...
vbool4_t test_vmslt_vx_i16m4_b4_m (vbool4_t mask, vbool4_t maskedoff, vint16m4_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv16i16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i1> %{{.*}}, <vscale x 16 x i16> %{{.*}}, i16 %{{.*}})
...
vbool2_t test_vmslt_vx_i16m8_b2_m (vbool2_t mask, vbool2_t maskedoff, vint16m8_t op1, int16_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv32i16{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i1> %{{.*}}, <vscale x 32 x i16> %{{.*}}, i16 %{{.*}})
...
vbool64_t test_vmslt_vx_i32mf2_b64_m (vbool64_t mask, vbool64_t maskedoff, vint32mf2_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i1> %{{.*}}, <vscale x 1 x i32> %{{.*}}, i32 %{{.*}})
...
vbool32_t test_vmslt_vx_i32m1_b32_m (vbool32_t mask, vbool32_t maskedoff, vint32m1_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i1> %{{.*}}, <vscale x 2 x i32> %{{.*}}, i32 %{{.*}})
...
vbool16_t test_vmslt_vx_i32m2_b16_m (vbool16_t mask, vbool16_t maskedoff, vint32m2_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i1> %{{.*}}, <vscale x 4 x i32> %{{.*}}, i32 %{{.*}})
...
vbool8_t test_vmslt_vx_i32m4_b8_m (vbool8_t mask, vbool8_t maskedoff, vint32m4_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i1> %{{.*}}, <vscale x 8 x i32> %{{.*}}, i32 %{{.*}})
...
vbool4_t test_vmslt_vx_i32m8_b4_m (vbool4_t mask, vbool4_t maskedoff, vint32m8_t op1, int32_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv16i32{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i1> %{{.*}}, <vscale x 16 x i32> %{{.*}}, i32 %{{.*}})
...
vbool64_t test_vmslt_vx_i64m1_b64_m (vbool64_t mask, vbool64_t maskedoff, vint64m1_t op1, int64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i1> %{{.*}}, <vscale x 1 x i64> %{{.*}}, i64 %{{.*}})
...
vbool32_t test_vmslt_vx_i64m2_b32_m (vbool32_t mask, vbool32_t maskedoff, vint64m2_t op1, int64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i1> %{{.*}}, <vscale x 2 x i64> %{{.*}}, i64 %{{.*}})
...
vbool16_t test_vmslt_vx_i64m4_b16_m (vbool16_t mask, vbool16_t maskedoff, vint64m4_t op1, int64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i1> %{{.*}}, <vscale x 4 x i64> %{{.*}}, i64 %{{.*}})
...
vbool8_t test_vmslt_vx_i64m8_b8_m (vbool8_t mask, vbool8_t maskedoff, vint64m8_t op1, int64_t op2) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i1> @llvm.riscv.vmslt.vx.{{.*}}nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i1> %{{.*}}, <vscale x 8 x i64> %{{.*}}, i64 %{{.*}})
