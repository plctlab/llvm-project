...
vint8mf8_t test_vle8ff_v_i8mf8_m (vbool64_t mask, vint8mf8_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i8> @llvm.riscv.vle8ff.v.mask.nxv1i8{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i8> %{{.*}}, i8 %{{.*}})
...
vint8mf4_t test_vle8ff_v_i8mf4_m (vbool32_t mask, vint8mf4_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i8> @llvm.riscv.vle8ff.v.mask.nxv2i8{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i8> %{{.*}}, i8 %{{.*}})
...
vint8mf2_t test_vle8ff_v_i8mf2_m (vbool16_t mask, vint8mf2_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i8> @llvm.riscv.vle8ff.v.mask.nxv4i8{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i8> %{{.*}}, i8 %{{.*}})
...
vint8m1_t test_vle8ff_v_i8m1_m (vbool8_t mask, vint8m1_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i8> @llvm.riscv.vle8ff.v.mask.nxv8i8{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i8> %{{.*}}, i8 %{{.*}})
...
vint8m2_t test_vle8ff_v_i8m2_m (vbool4_t mask, vint8m2_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i8> @llvm.riscv.vle8ff.v.mask.nxv16i8{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i8> %{{.*}}, i8 %{{.*}})
...
vint8m4_t test_vle8ff_v_i8m4_m (vbool2_t mask, vint8m4_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i8> @llvm.riscv.vle8ff.v.mask.nxv32i8{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i8> %{{.*}}, i8 %{{.*}})
...
vint8m8_t test_vle8ff_v_i8m8_m (vbool1_t mask, vint8m8_t maskedoff, int8_t *base) {
  ...
  // CHECK: %{{.*}} = call <vscale x 64 x i8> @llvm.riscv.vle8ff.v.mask.nxv64i8{{.*}}(<vscale x 64 x i1> %{{.*}}, <vscale x 64 x i8> %{{.*}}, i8 %{{.*}})
