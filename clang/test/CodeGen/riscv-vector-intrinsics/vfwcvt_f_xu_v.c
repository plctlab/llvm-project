...
vfloat32mf2_t test_vfwcvt_f_xu_v_f32mf2_m (vbool64_t mask, vfloat32mf2_t maskedoff, vuint16mf4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x float> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x float> %{{.*}}, <vscale x 1 x i16> %{{.*}})
...
vfloat32m1_t test_vfwcvt_f_xu_v_f32m1_m (vbool32_t mask, vfloat32m1_t maskedoff, vuint16mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x float> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x float> %{{.*}}, <vscale x 2 x i16> %{{.*}})
...
vfloat32m2_t test_vfwcvt_f_xu_v_f32m2_m (vbool16_t mask, vfloat32m2_t maskedoff, vuint16m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x float> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x float> %{{.*}}, <vscale x 4 x i16> %{{.*}})
...
vfloat32m4_t test_vfwcvt_f_xu_v_f32m4_m (vbool8_t mask, vfloat32m4_t maskedoff, vuint16m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x float> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x float> %{{.*}}, <vscale x 8 x i16> %{{.*}})
...
vfloat32m8_t test_vfwcvt_f_xu_v_f32m8_m (vbool4_t mask, vfloat32m8_t maskedoff, vuint16m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x float> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv16f32{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x float> %{{.*}}, <vscale x 16 x i16> %{{.*}})
...
vfloat64m1_t test_vfwcvt_f_xu_v_f64m1_m (vbool64_t mask, vfloat64m1_t maskedoff, vuint32mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x i32> %{{.*}})
...
vfloat64m2_t test_vfwcvt_f_xu_v_f64m2_m (vbool32_t mask, vfloat64m2_t maskedoff, vuint32m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x i32> %{{.*}})
...
vfloat64m4_t test_vfwcvt_f_xu_v_f64m4_m (vbool16_t mask, vfloat64m4_t maskedoff, vuint32m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x i32> %{{.*}})
...
vfloat64m8_t test_vfwcvt_f_xu_v_f64m8_m (vbool8_t mask, vfloat64m8_t maskedoff, vuint32m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vfwcvt.f.xu.v.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x i32> %{{.*}})
