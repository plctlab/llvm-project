...
vint8mf8_t test_vcompress_vm_i8mf8 (vbool64_t mask, vint8mf8_t maskedoff, vint8mf8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv1i8{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i8> %{{.*}}, <vscale x 1 x i8> %{{.*}})
...
vint8mf4_t test_vcompress_vm_i8mf4 (vbool32_t mask, vint8mf4_t maskedoff, vint8mf4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv2i8{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i8> %{{.*}}, <vscale x 2 x i8> %{{.*}})
...
vint8mf2_t test_vcompress_vm_i8mf2 (vbool16_t mask, vint8mf2_t maskedoff, vint8mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv4i8{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i8> %{{.*}}, <vscale x 4 x i8> %{{.*}})
...
vint8m1_t test_vcompress_vm_i8m1 (vbool8_t mask, vint8m1_t maskedoff, vint8m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv8i8{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i8> %{{.*}}, <vscale x 8 x i8> %{{.*}})
...
vint8m2_t test_vcompress_vm_i8m2 (vbool4_t mask, vint8m2_t maskedoff, vint8m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv16i8{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i8> %{{.*}}, <vscale x 16 x i8> %{{.*}})
...
vint8m4_t test_vcompress_vm_i8m4 (vbool2_t mask, vint8m4_t maskedoff, vint8m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv32i8{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i8> %{{.*}}, <vscale x 32 x i8> %{{.*}})
...
vint8m8_t test_vcompress_vm_i8m8 (vbool1_t mask, vint8m8_t maskedoff, vint8m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 64 x i8> @llvm.riscv.vcompress.vm.{{.*}}nxv64i8{{.*}}(<vscale x 64 x i1> %{{.*}}, <vscale x 64 x i8> %{{.*}}, <vscale x 64 x i8> %{{.*}})
...
vint16mf4_t test_vcompress_vm_i16mf4 (vbool64_t mask, vint16mf4_t maskedoff, vint16mf4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i16> @llvm.riscv.vcompress.vm.{{.*}}nxv1i16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x i16> %{{.*}})
...
vint16mf2_t test_vcompress_vm_i16mf2 (vbool32_t mask, vint16mf2_t maskedoff, vint16mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i16> @llvm.riscv.vcompress.vm.{{.*}}nxv2i16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x i16> %{{.*}})
...
vint16m1_t test_vcompress_vm_i16m1 (vbool16_t mask, vint16m1_t maskedoff, vint16m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i16> @llvm.riscv.vcompress.vm.{{.*}}nxv4i16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x i16> %{{.*}})
...
vint16m2_t test_vcompress_vm_i16m2 (vbool8_t mask, vint16m2_t maskedoff, vint16m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i16> @llvm.riscv.vcompress.vm.{{.*}}nxv8i16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x i16> %{{.*}})
...
vint16m4_t test_vcompress_vm_i16m4 (vbool4_t mask, vint16m4_t maskedoff, vint16m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i16> @llvm.riscv.vcompress.vm.{{.*}}nxv16i16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i16> %{{.*}}, <vscale x 16 x i16> %{{.*}})
...
vint16m8_t test_vcompress_vm_i16m8 (vbool2_t mask, vint16m8_t maskedoff, vint16m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x i16> @llvm.riscv.vcompress.vm.{{.*}}nxv32i16{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x i16> %{{.*}}, <vscale x 32 x i16> %{{.*}})
...
vint32mf2_t test_vcompress_vm_i32mf2 (vbool64_t mask, vint32mf2_t maskedoff, vint32mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vcompress.vm.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i32> %{{.*}}, <vscale x 1 x i32> %{{.*}})
...
vint32m1_t test_vcompress_vm_i32m1 (vbool32_t mask, vint32m1_t maskedoff, vint32m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vcompress.vm.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i32> %{{.*}}, <vscale x 2 x i32> %{{.*}})
...
vint32m2_t test_vcompress_vm_i32m2 (vbool16_t mask, vint32m2_t maskedoff, vint32m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vcompress.vm.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i32> %{{.*}}, <vscale x 4 x i32> %{{.*}})
...
vint32m4_t test_vcompress_vm_i32m4 (vbool8_t mask, vint32m4_t maskedoff, vint32m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vcompress.vm.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i32> %{{.*}}, <vscale x 8 x i32> %{{.*}})
...
vint32m8_t test_vcompress_vm_i32m8 (vbool4_t mask, vint32m8_t maskedoff, vint32m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i32> @llvm.riscv.vcompress.vm.{{.*}}nxv16i32{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x i32> %{{.*}}, <vscale x 16 x i32> %{{.*}})
...
vint64m1_t test_vcompress_vm_i64m1 (vbool64_t mask, vint64m1_t maskedoff, vint64m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i64> @llvm.riscv.vcompress.vm.{{.*}}nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x i64> %{{.*}}, <vscale x 1 x i64> %{{.*}})
...
vint64m2_t test_vcompress_vm_i64m2 (vbool32_t mask, vint64m2_t maskedoff, vint64m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i64> @llvm.riscv.vcompress.vm.{{.*}}nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x i64> %{{.*}}, <vscale x 2 x i64> %{{.*}})
...
vint64m4_t test_vcompress_vm_i64m4 (vbool16_t mask, vint64m4_t maskedoff, vint64m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i64> @llvm.riscv.vcompress.vm.{{.*}}nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x i64> %{{.*}}, <vscale x 4 x i64> %{{.*}})
...
vint64m8_t test_vcompress_vm_i64m8 (vbool8_t mask, vint64m8_t maskedoff, vint64m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i64> @llvm.riscv.vcompress.vm.{{.*}}nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x i64> %{{.*}}, <vscale x 8 x i64> %{{.*}})
...
vfloat16mf4_t test_vcompress_vm_f16mf4 (vbool64_t mask, vfloat16mf4_t maskedoff, vfloat16mf4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x half> @llvm.riscv.vcompress.vm.{{.*}}nxv1f16{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x half> %{{.*}}, <vscale x 1 x half> %{{.*}})
...
vfloat16mf2_t test_vcompress_vm_f16mf2 (vbool32_t mask, vfloat16mf2_t maskedoff, vfloat16mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x half> @llvm.riscv.vcompress.vm.{{.*}}nxv2f16{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x half> %{{.*}}, <vscale x 2 x half> %{{.*}})
...
vfloat16m1_t test_vcompress_vm_f16m1 (vbool16_t mask, vfloat16m1_t maskedoff, vfloat16m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x half> @llvm.riscv.vcompress.vm.{{.*}}nxv4f16{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x half> %{{.*}}, <vscale x 4 x half> %{{.*}})
...
vfloat16m2_t test_vcompress_vm_f16m2 (vbool8_t mask, vfloat16m2_t maskedoff, vfloat16m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x half> @llvm.riscv.vcompress.vm.{{.*}}nxv8f16{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x half> %{{.*}}, <vscale x 8 x half> %{{.*}})
...
vfloat16m4_t test_vcompress_vm_f16m4 (vbool4_t mask, vfloat16m4_t maskedoff, vfloat16m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x half> @llvm.riscv.vcompress.vm.{{.*}}nxv16f16{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x half> %{{.*}}, <vscale x 16 x half> %{{.*}})
...
vfloat16m8_t test_vcompress_vm_f16m8 (vbool2_t mask, vfloat16m8_t maskedoff, vfloat16m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 32 x half> @llvm.riscv.vcompress.vm.{{.*}}nxv32f16{{.*}}(<vscale x 32 x i1> %{{.*}}, <vscale x 32 x half> %{{.*}}, <vscale x 32 x half> %{{.*}})
...
vfloat32mf2_t test_vcompress_vm_f32mf2 (vbool64_t mask, vfloat32mf2_t maskedoff, vfloat32mf2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x float> @llvm.riscv.vcompress.vm.{{.*}}nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x float> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat32m1_t test_vcompress_vm_f32m1 (vbool32_t mask, vfloat32m1_t maskedoff, vfloat32m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x float> @llvm.riscv.vcompress.vm.{{.*}}nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x float> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat32m2_t test_vcompress_vm_f32m2 (vbool16_t mask, vfloat32m2_t maskedoff, vfloat32m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x float> @llvm.riscv.vcompress.vm.{{.*}}nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x float> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat32m4_t test_vcompress_vm_f32m4 (vbool8_t mask, vfloat32m4_t maskedoff, vfloat32m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x float> @llvm.riscv.vcompress.vm.{{.*}}nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x float> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat32m8_t test_vcompress_vm_f32m8 (vbool4_t mask, vfloat32m8_t maskedoff, vfloat32m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x float> @llvm.riscv.vcompress.vm.{{.*}}nxv16f32{{.*}}(<vscale x 16 x i1> %{{.*}}, <vscale x 16 x float> %{{.*}}, <vscale x 16 x float> %{{.*}})
...
vfloat64m1_t test_vcompress_vm_f64m1 (vbool64_t mask, vfloat64m1_t maskedoff, vfloat64m1_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vcompress.vm.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m2_t test_vcompress_vm_f64m2 (vbool32_t mask, vfloat64m2_t maskedoff, vfloat64m2_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vcompress.vm.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 2 x double> %{{.*}})
...
vfloat64m4_t test_vcompress_vm_f64m4 (vbool16_t mask, vfloat64m4_t maskedoff, vfloat64m4_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vcompress.vm.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 4 x double> %{{.*}})
...
vfloat64m8_t test_vcompress_vm_f64m8 (vbool8_t mask, vfloat64m8_t maskedoff, vfloat64m8_t src) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vcompress.vm.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 8 x double> %{{.*}})
