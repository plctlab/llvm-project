...
vfloat64m1_t test_vfredosum_vs_f64m1_f64m1_m (vbool64_t mask, vfloat64m1_t dst, vfloat64m1_t vector, vfloat64m1_t scalar) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfredosum.vs.mask.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m1_t test_vfredosum_vs_f64m2_f64m1_m (vbool32_t mask, vfloat64m1_t dst, vfloat64m2_t vector, vfloat64m1_t scalar) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfredosum.vs.mask.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 2 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m1_t test_vfredosum_vs_f64m4_f64m1_m (vbool16_t mask, vfloat64m1_t dst, vfloat64m4_t vector, vfloat64m1_t scalar) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfredosum.vs.mask.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 4 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m1_t test_vfredosum_vs_f64m8_f64m1_m (vbool8_t mask, vfloat64m1_t dst, vfloat64m8_t vector, vfloat64m1_t scalar) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vfredosum.vs.mask.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, <vscale x 1 x double> %{{.*}}, <vscale x 8 x double> %{{.*}}, <vscale x 1 x double> %{{.*}})
