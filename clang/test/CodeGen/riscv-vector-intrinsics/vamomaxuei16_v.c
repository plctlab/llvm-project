...
vuint32mf2_t test_vamomaxuei16_v_u32mf2_m (vbool64_t mask, uint32_t *base, vuint16mf4_t bindex, vuint32mf2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x i32> %{{.*}})
...
vuint32m1_t test_vamomaxuei16_v_u32m1_m (vbool32_t mask, uint32_t *base, vuint16mf2_t bindex, vuint32m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x i32> %{{.*}})
...
vuint32m2_t test_vamomaxuei16_v_u32m2_m (vbool16_t mask, uint32_t *base, vuint16m1_t bindex, vuint32m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x i32> %{{.*}})
...
vuint32m4_t test_vamomaxuei16_v_u32m4_m (vbool8_t mask, uint32_t *base, vuint16m2_t bindex, vuint32m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x i32> %{{.*}})
...
vuint32m8_t test_vamomaxuei16_v_u32m8_m (vbool4_t mask, uint32_t *base, vuint16m4_t bindex, vuint32m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i32> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv16i32{{.*}}(<vscale x 16 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 16 x i16> %{{.*}}, <vscale x 16 x i32> %{{.*}})
...
vuint64m1_t test_vamomaxuei16_v_u64m1_m (vbool64_t mask, uint64_t *base, vuint16mf4_t bindex, vuint64m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i64> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x i64> %{{.*}})
...
vuint64m2_t test_vamomaxuei16_v_u64m2_m (vbool32_t mask, uint64_t *base, vuint16mf2_t bindex, vuint64m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i64> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x i64> %{{.*}})
...
vuint64m4_t test_vamomaxuei16_v_u64m4_m (vbool16_t mask, uint64_t *base, vuint16m1_t bindex, vuint64m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i64> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x i64> %{{.*}})
...
vuint64m8_t test_vamomaxuei16_v_u64m8_m (vbool8_t mask, uint64_t *base, vuint16m2_t bindex, vuint64m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i64> @llvm.riscv.vamomaxuei16.v.{{.*}}nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x i64> %{{.*}})
