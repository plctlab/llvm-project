...
vfloat64m1_t test_vamoswapei16_v_f64m1 (float64_t *base, vuint16mf4_t bindex, vfloat64m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv1f64{{.*}}(double* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m2_t test_vamoswapei16_v_f64m2 (float64_t *base, vuint16mf2_t bindex, vfloat64m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv2f64{{.*}}(double* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x double> %{{.*}})
...
vfloat64m4_t test_vamoswapei16_v_f64m4 (float64_t *base, vuint16m1_t bindex, vfloat64m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv4f64{{.*}}(double* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x double> %{{.*}})
...
vfloat64m8_t test_vamoswapei16_v_f64m8 (float64_t *base, vuint16m2_t bindex, vfloat64m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv8f64{{.*}}(double* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x double> %{{.*}})
...
vint32mf2_t test_vamoswapei16_v_i32mf2_m (vbool64_t mask, int32_t *base, vuint16mf4_t bindex, vint32mf2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i32> @llvm.riscv.vamoswapei16.v.{{.*}}nxv1i32{{.*}}(<vscale x 1 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x i32> %{{.*}})
...
vint32m1_t test_vamoswapei16_v_i32m1_m (vbool32_t mask, int32_t *base, vuint16mf2_t bindex, vint32m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i32> @llvm.riscv.vamoswapei16.v.{{.*}}nxv2i32{{.*}}(<vscale x 2 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x i32> %{{.*}})
...
vint32m2_t test_vamoswapei16_v_i32m2_m (vbool16_t mask, int32_t *base, vuint16m1_t bindex, vint32m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i32> @llvm.riscv.vamoswapei16.v.{{.*}}nxv4i32{{.*}}(<vscale x 4 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x i32> %{{.*}})
...
vint32m4_t test_vamoswapei16_v_i32m4_m (vbool8_t mask, int32_t *base, vuint16m2_t bindex, vint32m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i32> @llvm.riscv.vamoswapei16.v.{{.*}}nxv8i32{{.*}}(<vscale x 8 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x i32> %{{.*}})
...
vint32m8_t test_vamoswapei16_v_i32m8_m (vbool4_t mask, int32_t *base, vuint16m4_t bindex, vint32m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x i32> @llvm.riscv.vamoswapei16.v.{{.*}}nxv16i32{{.*}}(<vscale x 16 x i1> %{{.*}}, i32* %{{.*}}, <vscale x 16 x i16> %{{.*}}, <vscale x 16 x i32> %{{.*}})
...
vint64m1_t test_vamoswapei16_v_i64m1_m (vbool64_t mask, int64_t *base, vuint16mf4_t bindex, vint64m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x i64> @llvm.riscv.vamoswapei16.v.{{.*}}nxv1i64{{.*}}(<vscale x 1 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x i64> %{{.*}})
...
vint64m2_t test_vamoswapei16_v_i64m2_m (vbool32_t mask, int64_t *base, vuint16mf2_t bindex, vint64m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x i64> @llvm.riscv.vamoswapei16.v.{{.*}}nxv2i64{{.*}}(<vscale x 2 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x i64> %{{.*}})
...
vint64m4_t test_vamoswapei16_v_i64m4_m (vbool16_t mask, int64_t *base, vuint16m1_t bindex, vint64m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x i64> @llvm.riscv.vamoswapei16.v.{{.*}}nxv4i64{{.*}}(<vscale x 4 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x i64> %{{.*}})
...
vint64m8_t test_vamoswapei16_v_i64m8_m (vbool8_t mask, int64_t *base, vuint16m2_t bindex, vint64m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x i64> @llvm.riscv.vamoswapei16.v.{{.*}}nxv8i64{{.*}}(<vscale x 8 x i1> %{{.*}}, i64* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x i64> %{{.*}})
...
vfloat32mf2_t test_vamoswapei16_v_f32mf2_m (vbool64_t mask, float32_t *base, vuint16mf4_t bindex, vfloat32mf2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x float> @llvm.riscv.vamoswapei16.v.{{.*}}nxv1f32{{.*}}(<vscale x 1 x i1> %{{.*}}, float* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x float> %{{.*}})
...
vfloat32m1_t test_vamoswapei16_v_f32m1_m (vbool32_t mask, float32_t *base, vuint16mf2_t bindex, vfloat32m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x float> @llvm.riscv.vamoswapei16.v.{{.*}}nxv2f32{{.*}}(<vscale x 2 x i1> %{{.*}}, float* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x float> %{{.*}})
...
vfloat32m2_t test_vamoswapei16_v_f32m2_m (vbool16_t mask, float32_t *base, vuint16m1_t bindex, vfloat32m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x float> @llvm.riscv.vamoswapei16.v.{{.*}}nxv4f32{{.*}}(<vscale x 4 x i1> %{{.*}}, float* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x float> %{{.*}})
...
vfloat32m4_t test_vamoswapei16_v_f32m4_m (vbool8_t mask, float32_t *base, vuint16m2_t bindex, vfloat32m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x float> @llvm.riscv.vamoswapei16.v.{{.*}}nxv8f32{{.*}}(<vscale x 8 x i1> %{{.*}}, float* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x float> %{{.*}})
...
vfloat32m8_t test_vamoswapei16_v_f32m8_m (vbool4_t mask, float32_t *base, vuint16m4_t bindex, vfloat32m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 16 x float> @llvm.riscv.vamoswapei16.v.{{.*}}nxv16f32{{.*}}(<vscale x 16 x i1> %{{.*}}, float* %{{.*}}, <vscale x 16 x i16> %{{.*}}, <vscale x 16 x float> %{{.*}})
...
vfloat64m1_t test_vamoswapei16_v_f64m1_m (vbool64_t mask, float64_t *base, vuint16mf4_t bindex, vfloat64m1_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 1 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv1f64{{.*}}(<vscale x 1 x i1> %{{.*}}, double* %{{.*}}, <vscale x 1 x i16> %{{.*}}, <vscale x 1 x double> %{{.*}})
...
vfloat64m2_t test_vamoswapei16_v_f64m2_m (vbool32_t mask, float64_t *base, vuint16mf2_t bindex, vfloat64m2_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 2 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv2f64{{.*}}(<vscale x 2 x i1> %{{.*}}, double* %{{.*}}, <vscale x 2 x i16> %{{.*}}, <vscale x 2 x double> %{{.*}})
...
vfloat64m4_t test_vamoswapei16_v_f64m4_m (vbool16_t mask, float64_t *base, vuint16m1_t bindex, vfloat64m4_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 4 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv4f64{{.*}}(<vscale x 4 x i1> %{{.*}}, double* %{{.*}}, <vscale x 4 x i16> %{{.*}}, <vscale x 4 x double> %{{.*}})
...
vfloat64m8_t test_vamoswapei16_v_f64m8_m (vbool8_t mask, float64_t *base, vuint16m2_t bindex, vfloat64m8_t value) {
  ...
  // CHECK: %{{.*}} = call <vscale x 8 x double> @llvm.riscv.vamoswapei16.v.{{.*}}nxv8f64{{.*}}(<vscale x 8 x i1> %{{.*}}, double* %{{.*}}, <vscale x 8 x i16> %{{.*}}, <vscale x 8 x double> %{{.*}})
