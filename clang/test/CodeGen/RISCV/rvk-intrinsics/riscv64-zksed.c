...
// RV64ZKN-LABEL: i64 @test_rv_sm4ks(
// RV64ZKN-NEXT:  entry:
...
// RV64ZKN-NEXT:  [[CALL:%.*]] = call i64 @_rv_sm4ks(i64 [[TMP0]], i64 [[TMP1]], i8 zeroext 0)
// RV64ZKN-NEXT:  ret i64 [[CALL]]
long test_rv_sm4ks(long rs1, long rs2){
    return _rv_sm4ks(rs1, rs2, 0);
}

// RV64ZKN-LABEL: i64 @test_rv_sm4ed(
// RV64ZKN-NEXT:  entry:
// RV64ZKN-NEXT:  [[RS1_ADDR:%.*]] = alloca i64, align 8
// RV64ZKN-NEXT:  [[RS2_ADDR:%.*]] = alloca i64, align 8
// RV64ZKN-NEXT:  store i64 [[RS1:%.*]], i64* [[RS1_ADDR]], align 8
...
// RV64ZKN-NEXT:  [[TMP0:%.*]] = load i64, i64* [[RS1_ADDR]], align 8
// RV64ZKN-NEXT:  [[TMP1:%.*]] = load i64, i64* [[RS2_ADDR]], align 8
// RV64ZKN-NEXT:  [[CALL:%.*]] = call i64 @_rv_sm4ed(i64 [[TMP0]], i64 [[TMP1]], i8 zeroext 0)
// RV64ZKN-NEXT:  ret i64 [[CALL]]
