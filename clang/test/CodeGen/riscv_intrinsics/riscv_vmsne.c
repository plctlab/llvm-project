...
//CHECK:   %6 = call <vscale x 8 x i1> @llvm.riscv.vmsne.vv.nxv8i1.nxv8i8.nxv8i8(<vscale x 8 x i8> %2, <vscale x 8 x i8> %3) #2
//CHECK:   %6 = call <vscale x 16 x i1> @llvm.riscv.vmsne.vv.nxv16i1.nxv4i16.nxv4i16(<vscale x 4 x i16> %2, <vscale x 4 x i16> %3) #2
//CHECK:   %6 = call <vscale x 32 x i1> @llvm.riscv.vmsne.vv.nxv32i1.nxv2i32.nxv2i32(<vscale x 2 x i32> %2, <vscale x 2 x i32> %3) #2
//CHECK:   %6 = call <vscale x 64 x i1> @llvm.riscv.vmsne.vv.nxv64i1.nxv1i64.nxv1i64(<vscale x 1 x i64> %2, <vscale x 1 x i64> %3) #2
