...
//CHECK:   %{{.*}} = call <vscale x 4 x i1> @llvm.riscv.vmsne.vv.nxv4i1.nxv4i16.nxv4i16(<vscale x 4 x i16> %{{.*}}, <vscale x 4 x i16> %{{.*}}) #{{.*}}
//CHECK:   %{{.*}} = call <vscale x 2 x i1> @llvm.riscv.vmsne.vv.nxv2i1.nxv2i32.nxv2i32(<vscale x 2 x i32> %{{.*}}, <vscale x 2 x i32> %{{.*}}) #{{.*}}
//CHECK:   %{{.*}} = call <vscale x 1 x i1> @llvm.riscv.vmsne.vv.nxv1i1.nxv1i64.nxv1i64(<vscale x 1 x i64> %{{.*}}, <vscale x 1 x i64> %{{.*}}) #{{.*}}
