// RUN: %clang_cc1 -triple riscv64-unknown-linux-elf -S -emit-llvm -O0 %s -o - | FileCheck %s
...
vint32m1_t test_vint32m1_t() {
  // CHECK: define dso_local <vscale x 2 x i32> @test_vint32m1_t() #0 {
...
// CHECK: declare dso_local <vscale x 2 x i32> @generate_vint32m1_t(...) #1
// CHECK: declare dso_local void @consume_vint32m1_t(<vscale x 2 x i32>) #1
...
vint16m1_t test_vint16m1_t() {
  // CHECK: define dso_local <vscale x 4 x i16> @test_vint16m1_t() #0 {
...
// CHECK: declare dso_local <vscale x 4 x i16> @generate_vint16m1_t(...) #1
// CHECK: declare dso_local void @consume_vint16m1_t(<vscale x 4 x i16>) #1
...
vint8m1_t test_vint8m1_t() {
  // CHECK: define dso_local <vscale x 8 x i8> @test_vint8m1_t() #0 {
...
// CHECK: declare dso_local <vscale x 8 x i8> @generate_vint8m1_t(...) #1
// CHECK: declare dso_local void @consume_vint8m1_t(<vscale x 8 x i8>) #1
...
vuint8m1_t test_vuint8m1_t() {
  // CHECK: define dso_local <vscale x 8 x i8> @test_vuint8m1_t() #0 {
  // CHECK: %x = alloca <vscale x 8 x i8>, align 8
...
// CHECK: declare dso_local <vscale x 8 x i8> @generate_vuint8m1_t(...) #1
// CHECK: declare dso_local void @consume_vuint8m1_t(<vscale x 8 x i8>) #1
...
vfloat32m1_t test_vfloat32m1_t() {
  // CHECK: define dso_local <vscale x 2 x float> @test_vfloat32m1_t() #0 {
...
// CHECK: declare dso_local <vscale x 2 x float> @generate_vfloat32m1_t(...) #1
// CHECK: declare dso_local void @consume_vfloat32m1_t(<vscale x 2 x float>) #1
...
vfloat16m1_t test_vfloat16m1_t() {
  // CHECK: define dso_local <vscale x 4 x half> @test_vfloat16m1_t() #0 {
