...
; RUN: llc -mtriple=riscv32 -mattr=+experimental-zcmp -verify-machineinstrs -frame-pointer=all < %s \
; RUN: | FileCheck %s -check-prefixes=RV32IZCMP-WITH-FP
...
; RUN: llc -mtriple=riscv64 -mattr=+experimental-zcmp -verify-machineinstrs -frame-pointer=all < %s \
; RUN: | FileCheck %s -check-prefixes=RV64IZCMP-WITH-FP
