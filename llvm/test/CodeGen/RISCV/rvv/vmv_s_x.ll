...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 1 x i8> @llvm.riscv.vmv.s.x.nxv1i8.i8(<vscale x 1 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 2 x i8> @llvm.riscv.vmv.s.x.nxv2i8.i8(<vscale x 2 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 4 x i8> @llvm.riscv.vmv.s.x.nxv4i8.i8(<vscale x 4 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 8 x i8> @llvm.riscv.vmv.s.x.nxv8i8.i8(<vscale x 8 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 16 x i8> @llvm.riscv.vmv.s.x.nxv16i8.i8(<vscale x 16 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 32 x i8> @llvm.riscv.vmv.s.x.nxv32i8.i8(<vscale x 32 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 64 x i8> @llvm.riscv.vmv.s.x.nxv64i8.i8(<vscale x 64 x i8> %dst, i8 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 1 x i16> @llvm.riscv.vmv.s.x.nxv1i16.i16(<vscale x 1 x i16> %dst, i16 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 2 x i16> @llvm.riscv.vmv.s.x.nxv2i16.i16(<vscale x 2 x i16> %dst, i16 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 4 x i16> @llvm.riscv.vmv.s.x.nxv4i16.i16(<vscale x 4 x i16> %dst, i16 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 8 x i16> @llvm.riscv.vmv.s.x.nxv8i16.i16(<vscale x 8 x i16> %dst, i16 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 16 x i16> @llvm.riscv.vmv.s.x.nxv16i16.i16(<vscale x 16 x i16> %dst, i16 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 32 x i16> @llvm.riscv.vmv.s.x.nxv32i16.i16(<vscale x 32 x i16> %dst, i16 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 1 x i32> @llvm.riscv.vmv.s.x.nxv1i32.i32(<vscale x 1 x i32> %dst, i32 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 2 x i32> @llvm.riscv.vmv.s.x.nxv2i32.i32(<vscale x 2 x i32> %dst, i32 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 4 x i32> @llvm.riscv.vmv.s.x.nxv4i32.i32(<vscale x 4 x i32> %dst, i32 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 8 x i32> @llvm.riscv.vmv.s.x.nxv8i32.i32(<vscale x 8 x i32> %dst, i32 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 16 x i32> @llvm.riscv.vmv.s.x.nxv16i32.i32(<vscale x 16 x i32> %dst, i32 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 1 x i64> @llvm.riscv.vmv.s.x.nxv1i64.i64(<vscale x 1 x i64> %dst, i64 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 2 x i64> @llvm.riscv.vmv.s.x.nxv2i64.i64(<vscale x 2 x i64> %dst, i64 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 4 x i64> @llvm.riscv.vmv.s.x.nxv4i64.i64(<vscale x 4 x i64> %dst, i64 %src)
...
; CHECK: vmv.s.x {{v[0-9]+}}, {{a[0-9]+}}
  %call = tail call <vscale x 8 x i64> @llvm.riscv.vmv.s.x.nxv8i64.i64(<vscale x 8 x i64> %dst, i64 %src)
