...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,mf8,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 5)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,mf4,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 6)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,mf2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 7)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,m1,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 0)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,m2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 1)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,m4,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 2)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e8,m8,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 3)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e16,mf4,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 14)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e16,mf2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 15)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e16,m1,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 8)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e16,m2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 9)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e16,m4,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 10)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e16,m8,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 11)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e32,mf2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 23)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e32,m1,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 16)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e32,m2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 17)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e32,m4,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 18)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e32,m8,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 19)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e64,m1,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 24)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e64,m2,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 25)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e64,m4,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 26)
  ret i64 %call
}
...
; CHECK: vsetvli {{a[0-9]+}}, {{a[0-9]+}}, e64,m8,tu,mu
  %call = tail call i64 @llvm.riscv.vsetvl(i64 %avl, i64 27)
  ret i64 %call
}
