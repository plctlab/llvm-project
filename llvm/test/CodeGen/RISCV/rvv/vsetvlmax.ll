...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,mf8,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 5)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,mf4,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 6)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,mf2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 7)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,m1,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 0)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,m2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 1)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,m4,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 2)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e8,m8,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 3)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e16,mf4,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 14)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e16,mf2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 15)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e16,m1,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 8)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e16,m2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 9)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e16,m4,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 10)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e16,m8,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 11)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e32,mf2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 23)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e32,m1,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 16)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e32,m2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 17)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e32,m4,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 18)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e32,m8,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 19)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e64,m1,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 24)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e64,m2,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 25)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e64,m4,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 26)
  ret i64 %0
}
...
; CHECK: vsetvli a{{.*}}, a{{.*}}, e64,m8,tu,mu
  %0 = call i64 @llvm.riscv.vsetvl(i64 -1, i64 27)
  ret i64 %0
}
