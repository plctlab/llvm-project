...
; RUN: llc -mtriple=riscv32 -mattr=+m,+experimental-zce,-zce-muli -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV32IMZce %s
; RUN: llc -mtriple=riscv64 -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV64I %s
; RUN: llc -mtriple=riscv64 -mattr=+m,+experimental-zce,-zce-muli -verify-machineinstrs < %s \
