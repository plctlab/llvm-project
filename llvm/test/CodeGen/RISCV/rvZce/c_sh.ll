...
; RUN: llc -mtriple=riscv32 -mattr=+zce-csbh,zce-clbh -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV32IZce %s
; RUN: llc -mtriple=riscv64 -verify-machineinstrs < %s \
; RUN:   | FileCheck -check-prefix=RV64I %s
; RUN: llc -mtriple=riscv64 -mattr=+zce-csbh,zce-clbh -verify-machineinstrs < %s \
...
; RV32IZce-LABEL: sh:
; RV32IZce:       # %bb.0:
; RV32IZce-NEXT:    c.sh a1, 0(a0)
; RV32IZce-NEXT:    c.sh a1, 14(a0)
; RV32IZce-NEXT:    ret
  store i16 %b, i16* %a
...
define dso_local void @sh64(i16 *%a, i16 %b) nounwind {
; RV64I-LABEL: sh64:
; RV64I:       # %bb.0:
...
; RV64IZce-LABEL: sh64:
; RV64IZce:       # %bb.0:
; RV64IZce-NEXT:    c.sh a1, 0(a0)
; RV64IZce-NEXT:    c.sh a1, 16(a0)
; RV64IZce-NEXT:    ret
  store i16 %b, i16* %a
...
; RV64IZce-NEXT:    mv a0, s2
; RV64IZce-NEXT:    call __divdi3@plt
; RV64IZce-NEXT:    addw a0, s8, a0
; RV64IZce-NEXT:    addw a1, s7, s1
; RV64IZce-NEXT:    addw a2, s6, s4
; RV64IZce-NEXT:    addw a3, s5, s9
