...
ldgp a0, %lo(val)(gp)
# CHECK-INSTR: ldgp	a0, 22136(gp)
# CHECK-FIXUP: fixup A - offset: 0, value: %lo(val), kind: fixup_riscv_zce_ldgp
addi a1, t1, %lo(val)
# CHECK-FIXUP: fixup A - offset: 0, value: %lo(val), kind: fixup_riscv_lo12_i
...
sdgp a0, %lo(val)(gp)
# CHECK-FIXUP: fixup A - offset: 0, value: %lo(val), kind: fixup_riscv_zce_sdgp
# CHECK-INSTR: sdgp a0, 22136(gp)
