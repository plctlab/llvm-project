# With P extension:
# RUN: llvm-mc -triple=riscv64 -show-encoding --mattr=+experimental-p -riscv-no-aliases %s \
# RUN:        | FileCheck %s --check-prefixes=CHECK-ENCODING,CHECK-INST
# RUN: not llvm-mc -triple=riscv64 -show-encoding %s 2>&1 \
# RUN:        | FileCheck %s --check-prefix=CHECK-ERROR
# RUN: llvm-mc -triple=riscv64 -filetype=obj --mattr=+experimental-p %s \
# RUN:        | llvm-objdump -d --mattr=+experimental-p -M no-aliases - \
# RUN:        | FileCheck %s --check-prefix=CHECK-INST
# RUN: llvm-mc -triple=riscv64 -filetype=obj --mattr=+experimental-p %s \
# RUN:        | llvm-objdump -d - | FileCheck %s --check-prefix=CHECK-UNKNOWN

# With Zpsfoperand extension:
# RUN: llvm-mc -triple=riscv64 -show-encoding --mattr=+experimental-zpsfoperand %s \
# RUN:        | FileCheck %s --check-prefixes=CHECK-ENCODING,CHECK-INST
# RUN: not llvm-mc -triple=riscv64 -show-encoding %s 2>&1 \
# RUN:        | FileCheck %s --check-prefix=CHECK-ERROR
# RUN: llvm-mc -triple=riscv64 -filetype=obj --mattr=+experimental-zpsfoperand %s \
...
# CHECK-INST: smal a1, a2, a3
# CHECK-ENCODING: [0xf7,0x15,0xd6,0x5e]
# CHECK-ERROR: instruction requires the following: 'Zpsfoperand' (64-bit operand 'P' Instructions)
# CHECK-UNKNOWN: f7 15 d6 5e <unknown>
smal a1, a2, a3
...
# CHECK-ERROR: instruction requires the following: 'Zpsfoperand' (64-bit operand 'P' Instructions)
# CHECK-UNKNOWN: f7 15 d6 90 <unknown>
kadd64 a1, a2, a3

# CHECK-INST: ksub64 a4, a5, a6
# CHECK-ENCODING: [0x77,0x97,0x07,0x93]
# CHECK-ERROR: instruction requires the following: 'Zpsfoperand' (64-bit operand 'P' Instructions)
# CHECK-UNKNOWN: 77 97 07 93 <unknown>
ksub64 a4, a5, a6
...
# CHECK-INST: wext a0, a1, a2
# CHECK-ENCODING: [0x77,0x85,0xc5,0xce]
# CHECK-ERROR: instruction requires the following: 'Zpsfoperand' (64-bit operand 'P' Instructions)
# CHECK-UNKNOWN: 77 85 c5 ce <unknown>
wext a0, a1, a2

# CHECK-INST: wexti a0, a1, 7
# CHECK-ENCODING: [0x77,0x85,0x75,0xde]
# CHECK-ERROR: instruction requires the following: 'Zpsfoperand' (64-bit operand 'P' Instructions)
# CHECK-UNKNOWN: 77 85 75 de <unknown>
wexti a0, a1, 7
