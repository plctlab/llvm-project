...
# CHECK-NO-EXT-FC:  error: instruction requires the following: 'C' (Compressed Instructions) or 'Zcf' (c.flw, c.flwsp, c.fsw, c.fswsp), 'F' (Single-Precision Floating-Point)
