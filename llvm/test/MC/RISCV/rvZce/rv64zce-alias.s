...
# CHECK-NO-EXT: error: instruction requires the following: 'C' (Compressed Instructions), 'Zcee' (high performance cores v0.41)
# CHECK-NO-RV64: error: instruction requires the following: RV64I Base Instruction Set
# CHECK-NO-RV64-AND-EXT: error: instruction requires the following: 'C' (Compressed Instructions), 'Zcee' (high performance cores v0.41), RV64I Base Instruction Set
c.sext.w s0
