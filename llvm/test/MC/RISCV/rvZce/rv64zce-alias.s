...
# CHECK-NO-EXT: error: instruction requires the following: 'Sext' from 'Zcee' (high performance cores v0.50), 'C' (Compressed Instructions)
# CHECK-NO-RV64: error: instruction requires the following: RV64I Base Instruction Set
# CHECK-NO-RV64-AND-EXT: error: instruction requires the following: 'Sext' from 'Zcee' (high performance cores v0.50), 'C' (Compressed Instructions), RV64I Base Instruction Set
c.sext.w s0
