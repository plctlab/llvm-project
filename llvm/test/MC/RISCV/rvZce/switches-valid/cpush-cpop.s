# RUN: llvm-mc %s -triple=riscv32 -mattr=+experimental-zcmp -mattr=m -riscv-no-aliases -show-encoding \
# RUN:     | FileCheck -check-prefixes=CHECK-ASM %s
# RUN: llvm-mc -filetype=obj -triple=riscv32 -mattr=+experimental-zcmp -mattr=m < %s \
# RUN:     | llvm-objdump --mattr=+experimental-zcmp  --mattr=m -M no-aliases -d -r - \
